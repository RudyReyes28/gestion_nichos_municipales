<!-- resources/views/ayudante/gestion_responsables.blade.php -->
...
@section('contenido')
    <div class="card card-admin mb-4">
        <div class="card-header bg-light d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('ayudante.gestion_usuarios') }}" class="btn btn-sm btn-secondary">
    ...
    <div class="modal fade" id="modalEditarResponsable" tabindex="-1" aria-labelledby="modalEditarResponsableLabel"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="{{ route('ayudante.gestion_responsables.editar_responsable') }}" method="POST">
                    @csrf
                    <div class="modal-body">
                        ...
                        <div class="row mt-3">
                            <div class="col-12">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="editDireccion" name="descripcion_direccion"
                                        rows="3"></textarea>
                                </div>
                            </div>
                        </div>
