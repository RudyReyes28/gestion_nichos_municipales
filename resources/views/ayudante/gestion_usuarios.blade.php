<!-- resources/views/ayudante/gestion_usuarios.blade.php -->
        ...
        <div class="col-md-6 mb-6">
            <div class="card card-admin h-100">
                <div class="card-body">
                    ...
                    <div class="d-grid">
                        <a href="{{ route('ayudante.gestion_ocupantes') }}" class="btn btn-outline-primary">
        ...
        <div class="col-md-6 mb-6">
            <div class="card card-admin h-100">
                <div class="card-body">
                    ...
                    <div class="d-grid">
                        <a href="{{ route('ayudante.gestion_responsables') }}" class="btn btn-outline-success">
                            <i class="fas fa-cog me-2"></i>Administrar
                        </a>
                    </div>
                </div>
