<!-- resources/views/ayudante/generar_boleta.blade.php -->
    ...
    <div class="col-lg-8 mx-auto">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('ayudante.contratos.aceptar_contrato') }}" method="POST" class="mt-4" id="form-generar-boleta">
                    @csrf
                    ...
                    <div class="d-flex justify-content-between">
                        <a href="{{ route('ayudante.contratos') }}" class="btn btn-secondary">
