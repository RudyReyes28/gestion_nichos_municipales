    ...
    <div class="col-lg-8 mx-auto">
        <div class="card">
            <div class="card-header bg-primary text-white">
                <h5 class="mb-0">Generar Boleta de Pago -Renovacion Contrato #{{ $contrato->id_contrato }}</h5>
            </div>
            <div class="card-body">
                ...
                <div class="boleta-preview" id="boleta-content">
                    <div class="boleta-header">
                        ...
                        <h4>BOLETA DE PAGO -RENOVACION CONTRATO DE NICHO</h4>
                ...
                <form action="{{ route('usuario.aceptar_renovacion_contrato') }}" method="POST" class="mt-4" id="form-generar-boleta">
                    @csrf
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <button type="button" class="btn btn-success" id="btn-generar-boleta">
                            <i class="fas fa-file-invoice-dollar me-1"></i> Confirmar y Pagar Boleta
                        </button>
                    </div>
                </form>
            </div>
