...
@section('titulo', 'Ver Todas las Exhumaciones')

@section('titulo_seccion')
    <i class="fas fa-list me-2"></i>Todas las Exhumaciones
@endsection
    ...
    <div class="col-12">
        <div class="card card-admin">
            <div class="card-header bg-transparent d-flex justify-content-between align-items-center">
                <h5 class="card-title mb-0"><i class="fas fa-exchange-alt me-2"></i>Historial de Exhumaciones</h5>
                <a href="{{ route('admin.gestion_exhumacion') }}" class="btn btn-sm btn-primary">
            ...
            <div class="card-body">
                ...
                @if(count($exhumaciones) > 0)
                    <div class="table-responsive">
                        <table class="table table-hover table-striped" id="exhumacionesTable">
                            ...
                            <tbody>
                                ...
                                <tr data-estado="{{ $exhumacion->estado_exhumacion }}">
                                    ...
                                    <td>
                                        @php
                                            ...
                                            switch($exhumacion->estado_exhumacion) {
                                                case 'solicitado':
                                        ...
                                        @endphp
                                        <span class="badge {{ $badgeClass }}">{{ ucfirst($exhumacion->estado_exhumacion) }}</span>
                                    </td>
                                    <td>
                ...
                @else
                    <div class="alert alert-info">
                        <i class="fas fa-info-circle me-2"></i>No hay registros de exhumaciones en el sistema.
                    </div>
                @endif
            </div>
        </div>
    ...
    <div class="col-md-12">
        <div class="card card-admin mb-4">
            <div class="card-header bg-transparent">
                <h5 class="card-title mb-0"><i class="fas fa-chart-pie me-2"></i>Estadísticas de Exhumaciones</h5>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-3">
                        <div class="card bg-light mb-3">
                            <div class="card-body text-center">
                                <h6 class="card-title">Solicitadas</h6>
                                <h3 class="text-warning">
                                    {{ collect($exhumaciones)->where('estado_exhumacion', 'solicitado')->count() }}
                                </h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="card bg-light mb-3">
                            <div class="card-body text-center">
                                <h6 class="card-title">Aceptadas</h6>
                                <h3 class="text-success">
                                    {{ collect($exhumaciones)->where('estado_exhumacion', 'aprobada')->count() }}
                                </h3>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card bg-light mb-3">
                            <div class="card-body text-center">
                                ...
                                <h3 class="text-danger">
                                    {{ collect($exhumaciones)->where('estado_exhumacion', 'rechazada')->count() }}
                                </h3>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="detalleModal{{ $exhumacion->id_exhumacion }}" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
                    @if($exhumacion->estado_exhumacion == 'solicitado')
                        <div class="btn-group">
...
<script>
    ...
    document.getElementById('filterStatus').addEventListener('change', function() {
        ...
        const rows = document.querySelectorAll('#exhumacionesTable tbody tr');
