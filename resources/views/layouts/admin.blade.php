...
<head>
    ...
    <title>Panel Administrativo - @yield('titulo')</title>
    <!-- Bootstrap CSS -->
...
<body>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown">
                            <div class="d-flex align-items-center">
                                ...
                                <span>{{ $persona->nombre ?? 'Admin' }} {{ $persona->apellido ?? '' }}</span>
                            </div>
                        </a>
            ...
            <div class="col-md-3 col-lg-2 px-0 sidebar">
                <div class="d-flex flex-column p-3">
                    <ul class="nav nav-pills flex-column mb-auto">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.contratos') }}" class="nav-link {{ request()->routeIs('admin.contratos*') ? 'active' : '' }}">
    ...
    <footer class="footer text-center">
        <div class="container">
            <span>© {{ date('Y') }} Sistema de Gestión de Nichos Municipales - Panel Administrativo</span>
        </div>
    </footer>
