...
class GestionNichosController extends Controller
{
    //
    ...
    { 
        ...
        return view('admin.gestion_nichos', compact('persona', 'nichos', 'tipos_nicho'));
    }
    ...
    public function crearNicho(Request $request){
        ...
        if($id_calle == null){
            return redirect()->route('admin.gestion_nichos')->with('error', 'Error al agregar la calle');
        }
        ...
        if($id_avenida == null){
            return redirect()->route('admin.gestion_nichos')->with('error', 'Error al agregar la avenida');
        }
        ...
        if($id_ubicacion == null){
            return redirect()->route('admin.gestion_nichos')->with('error', 'Error al agregar la ubicacion');
        }
        //creamos el nicho
        ...
        if($id_nicho == null){
            return redirect()->route('admin.gestion_nichos')->with('error', 'Error al agregar el nicho');
        }else{
            return redirect()->route('admin.gestion_nichos')->with('success', 'Nicho creado correctamente');
        }
